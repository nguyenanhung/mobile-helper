...
if (!function_exists('Mobile_Detect')) {
     ...
     * @copyright: 713uk13m <dev@nguyenanhung.com>
     * @time     : 13/12/2022 09:13
     */
    function Mobile_Detect($userAgent = null, $httpHeaders = null): MobileDetect
    {
        return new MobileDetect($userAgent, $httpHeaders);
    }
}
...
if (!function_exists('is_SamsungTablet')) {
    function is_SamsungTablet($userAgent = null, $httpHeaders = null): bool
    {
